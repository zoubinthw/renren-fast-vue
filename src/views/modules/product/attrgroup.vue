...
/*
* 父子组件传递数据
* 1) 子组件给副组件传递数据：事件机制;子组件中元素被点击了给父组件发送一个事件并携带数据
*    // this.$emit('事件名字', 可携带的数据...)
* */
...
// 方法集合
  methods: {
    ...
    treeNodeClick (data, node, component) {
      console.log('attr-group感知到子组件Category的节点被点击: ', data, node, component)
      console.log('刚才被点击的菜单ID为: ', data.catId)
      if (node.level === 3) {
